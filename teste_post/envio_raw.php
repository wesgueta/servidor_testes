...
if ($conn->connect_error) {
 ...
 echo $responseBody;
 $responseBody = substr($responseBody, 2);
 $responseBody = substr($responseBody,0,-3);
 $responseBody = str_replace("(","[",$responseBody);
 $responseBody = str_replace(")","]",$responseBody);
 $responseBody = str_replace('\\',"",$payload);
 echo "após os replaces: ",$responseBody;
 file_put_contents("teste.txt",$responseBody);
 //return data
 //Save in json file
